...
#   c) node1 mines 61 blocks, so now nodes 0 and 1 have 500.000 indio, node2 has none. 
#   d) node0 sends 210.000 indio to node2, in two transactions (110.000 indio, then 100.000 indio).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 INDIO from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 indio in block rewards plus fees, but
        ...
        # Send 100000 INDIO with subtract fee from amount
