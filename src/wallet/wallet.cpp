        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Indio: Disable free transactions
...
{
    // Indio: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Indio: Add an increased fee for each dust output
        nFeeNeeded += GetIndioDustFee(tx.vout, minTxFee);
    }
