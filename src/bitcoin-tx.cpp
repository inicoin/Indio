...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Indio Core indio-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  indio-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded indio transaction") + "\n" +
              "  indio-tx [options] -create [commands]   " + _("Create hex-encoded indio transaction") + "\n" +
              "\n";
