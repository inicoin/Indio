    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceIndio = 40;
    ...
    QString titleText       = tr("Indio Core");
    ...
    QString copyrightTextIndio  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Indio Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceIndio,copyrightTextIndio);
