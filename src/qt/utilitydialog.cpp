    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Indio Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Indio Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  indio-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Indio Core is shutting down...") + "<br /><br />" +
