...
// Copyright (c) 2014-2015 The Indio Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Indio Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Indio: load fallback font in case Comic Sans is not availble on the system
    ...
    // Indio: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Indio: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Indio address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and indio: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Indio Core"), this);
    aboutAction->setStatusTip(tr("Show information about Indio Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Indio Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Indio addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Indio addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Indio Core help message to get a list with possible Indio command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Indio Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Indio network", "", count));
}
...
{
    QString strTitle = tr("Indio"); // default title
