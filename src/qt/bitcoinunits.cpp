...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MINI");
    case kBTC: return QString("kINI");
    case BTC: return QString("INI");
    case mBTC: return QString("mINI");
    case uBTC: return QChar(0x03BC) + QString("INI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-Indios (1,000,000)");
    case kBTC: return tr("Kilo-Indios (1,000)");
    case BTC: return tr("Indios");
    case mBTC: return tr("Milli-Indios (1 / 1,000)");
    case uBTC: return tr("Micro-Indios (1 / 1,000,000)");
    default: return QString("???");
    }
}
